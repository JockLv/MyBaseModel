...
public abstract class MvpPictureActivity<P extends MvpBasePresenter> extends AppCompatActivity implements InvokeListener, TakePhoto.TakeResultListener, MvpView {
    private static final String TAG = MvpPictureActivity.class.getSimpleName();
    ...
    protected abstract boolean NotTranslucent();
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        final PermissionManager.TPermissionType type = PermissionManager.onRequestPermissionsResult(requestCode, permissions, grantResults);
    ...
    public PermissionManager.TPermissionType invoke(InvokeParam invokeParam) {
        final PermissionManager.TPermissionType type = PermissionManager.checkPermission(TContextWrap.of(this), invokeParam.getMethod());
    ...
    public void takeSuccess(TResult result) {
        LogUtils.logd(TAG, "图片回调takeSuccess");
    }

    @Override
    public void takeFail(TResult result, String msg) {
        LogUtils.logd(TAG, "图片回调takeFail:"+msg);
    }

    @Override
    public void takeCancel() {
        LogUtils.logd(TAG, "图片回调takeCancel");
    }
