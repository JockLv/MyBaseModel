...
import com.example.administrator.mybasemodel.BuildConfig;
...
public class FileUtils {
    ...
    private static final String APP_NAME = "car" + BuildConfig.FLAVOR;
    ...
    public static File getImgFile(Context context, String name){
        File image = new File(getFileDir(context, "image"), name);
        //createDir(image);
        return image;
    }
    ...
    public static String FormetFileSize(long fileS){// 转换文件大小
        ...
        if (fileS < 1024) {
            fileSizeString = FormatUtils.formatFileSize((double)fileS) + "B";
        } else if (fileS < 1048576) {
            fileSizeString = FormatUtils.formatFileSize((double)fileS / 1024) + "KB";
        } else if (fileS < 1073741824) {
            fileSizeString = FormatUtils.formatFileSize((double)fileS / 1048576) + "MB";
        } else {
            fileSizeString = FormatUtils.formatFileSize((double)fileS / 1073741824) + "GB";
        }
